...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  (0, _video.findVideos)();
  (0, _menu.detectedScript)();
  (0, _menu.toggleClickHandler)();
...
},{"./modules/form-validate/form.js":3,"./modules/menu.js":9,"./modules/select/custom-select.js":11,"./modules/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.toggleClickHandler = exports.detectedScript = void 0;
var toggle = document.querySelector('.js-toggle');
var menu = document.querySelector('.js-menu');
var detectedScript = exports.detectedScript = function detectedScript() {
  document.querySelector('.no-js').classList.remove('no-js');
  menu.classList.add('site-nav__list--closed');
  toggle.classList.add('site-nav__toggle--open');
};
var toggleClickHandler = exports.toggleClickHandler = function toggleClickHandler() {
...
},{"./create-select-markup":10,"./utils":12}],12:[function(require,module,exports){
"use strict";
